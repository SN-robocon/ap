...
SmartCarryScene::SmartCarryScene(Tracer* tracer)
    : ISceneManager(tracer),
      drive_(tracer),
      tracer_(tracer),
      angle_condition_r1_(tracer_, 51.2f),//52		//赤ペットボトルを持って旋回
      angle_condition_r2_(tracer_, 25.0f), // 38	//後退後旋回
      angle_condition_r3_(tracer_, 50.0f), // 54	//青ペットボトルを持って旋回
      angle_condition_r4_(tracer_, 15.0f),			//後退後旋回
      angle_condition_r5_(tracer_, 56.0f), // 30	//ラインに向けて旋回
      angle_condition_r6_(tracer_, 17.0f),			//ライン付近で旋回
      
      mileage_condition_1_(tracer_, 1450), // 1個目のサークルまでの直進
      mileage_condition_2_(tracer_, 80),  // 1回目　後退
      mileage_condition_3_(tracer_, 500),  // 後退→旋回後の直進 450
      mileage_condition_4_(tracer_, 800),  // 2個目のサークルまでの直進
      mileage_condition_5_(tracer_, 60),  // 2回目の後退 80
