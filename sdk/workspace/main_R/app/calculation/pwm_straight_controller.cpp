...
//            pwm_left = static_cast<double>(base_pwm_left_) - correction;
//            pwm_right = static_cast<double>(base_pwm_right_) + correction;

            double diff = static_cast<double>(right_count - left_count);
            double correction = Kp_ * diff;

//            pwm_left = static_cast<double>(base_pwm_left_) + correction;
            pwm_left = static_cast<double>(base_pwm_left_) + correction - 10;
            pwm_right = static_cast<double>(base_pwm_right_) - correction;
