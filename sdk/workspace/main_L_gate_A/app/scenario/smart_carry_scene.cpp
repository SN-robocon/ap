...
SmartCarryScene::SmartCarryScene(Tracer* tracer)
    : ISceneManager(tracer),
      drive_(tracer),
      tracer_(tracer),
      angle_condition_r1_(tracer_, 30.0f),				//赤ペットボトルを持って旋回
      angle_condition_r2_(tracer_, 13.5f),//追加		//ゲートに向けて旋回
      angle_condition_r3_(tracer_, 50.0f),//追加		//ゲート前で旋回
      angle_condition_r4_(tracer_, 51.0f),//追加//52	//ゲート通過後に旋回
      angle_condition_r5_(tracer_, 25.0f), // 38		//後退後旋回
      angle_condition_r6_(tracer_, 20.0f), // 54		//ラインに向けて旋回
      angle_condition_r7_(tracer_, 51.5f),//50			//青ペットボトルを持って旋回
      angle_condition_r8_(tracer_, 13.0f), // 30		//後退後旋回
      angle_condition_r9_(tracer_, 55.0f),				//ラインに向けて旋回
      
      mileage_condition_1_(tracer_, 450), // ゲート正面まで
      mileage_condition_2_(tracer_, 780), // ゲート通過
      mileage_condition_3_(tracer_, 120), // サークル前まで
      mileage_condition_4_(tracer_, 90), // サークル中央まで

      mileage_condition_5_(tracer_, 80),  // 1回目　後退
      mileage_condition_6_(tracer_, 520),  // 後退→旋回後の直進 450
