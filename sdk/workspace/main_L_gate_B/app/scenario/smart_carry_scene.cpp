...
SmartCarryScene::SmartCarryScene(Tracer* tracer)
    : ISceneManager(tracer),
      drive_(tracer),
      tracer_(tracer),
      angle_condition_r1_(tracer_, 18.0f),				//赤ペットボトルを持って旋回
      angle_condition_r2_(tracer_, 28.0f),//追加  26	//ゲートに向けて旋回
      angle_condition_r3_(tracer_, 51.0f),//追加		//ゲート前で旋回
      angle_condition_r4_(tracer_, 46.0f),//追加		//ゲート通過後に旋回
      angle_condition_r5_(tracer_, 21.0f), // 38 25		//後退後旋回
      angle_condition_r6_(tracer_, 24.0f), // 54		//ラインに向けて旋回
      angle_condition_r7_(tracer_, 50.0f),				//青ペットボトルを持って旋回
      angle_condition_r8_(tracer_, 13.0f), // 30		//後退後旋回
      angle_condition_r9_(tracer_, 57.0f),				//ラインに向けて旋回
      
      mileage_condition_1_(tracer_, 600), // ゲート正面まで   500 520
      mileage_condition_2_(tracer_, 850), // ゲート通過
      mileage_condition_3_(tracer_, 340), // サークル前まで  410
      mileage_condition_4_(tracer_, 50), // サークル中央まで    90
      mileage_condition_5_(tracer_, 80),  // 1回目　後退
      mileage_condition_6_(tracer_, 410),  // 後退→旋回後の直進 450
      mileage_condition_7_(tracer_, 810),  // 2個目のサークルまでの直進
