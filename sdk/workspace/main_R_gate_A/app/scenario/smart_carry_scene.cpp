...
SmartCarryScene::SmartCarryScene(Tracer* tracer)
    : ISceneManager(tracer),
      drive_(tracer),
      tracer_(tracer),
      angle_condition_r1_(tracer_, 30.0f),
      angle_condition_r2_(tracer_, 10.0f),//追加//12
      angle_condition_r3_(tracer_, 50.0f),//追加
      angle_condition_r4_(tracer_, 52.0f),//追加
      angle_condition_r5_(tracer_, 25.0f), // 38
      ...
      mileage_condition_1_(tracer_, 520), // ゲート正面まで
      mileage_condition_2_(tracer_, 780), // ゲート通過
      mileage_condition_3_(tracer_, 110), // サークル前まで95
      mileage_condition_4_(tracer_, 50), // サークル中央まで 80
